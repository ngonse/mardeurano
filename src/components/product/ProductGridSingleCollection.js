...
const ProductGridSingleCollection = ({
  product,
  currency,
  addToCart,
  addToWishlist,
  ...
  const image = get(product, "image.localFile.childImageSharp.fixed.src");
...
ProductGridSingleCollection.propTypes = {
...
export default ProductGridSingleCollection;
